...
public class OpenStreetMapReverseLookup extends Object {
    ...
    public void setAddress(OpenStreetMapAddress address) {
    ...
    public String getWidgetSettingsCityName() {
        String city = "";
        if (getAddress() != null && getAddress().getCity() != null)
            city = getAddress().getCity();
        else if (getAddress() != null && getAddress().getSuburb() != null)
            city = getAddress().getCity();
        else if (getAddress() != null && getAddress().getStateDistrict() != null)
            city = getAddress().getCity();
        return city;
    }
}